  ...
  .then((data) => {
    data.forEach((header) => {
      ...
      <nav class="navbar">
        ...
        <a class="github_btn" href="https://github.com/Skalb8865" aria-label="Contact Me" target="_blank">Github</a>
        <div class="hamburger" id="hamburger" aria-label="open menu" aria-controls="menu" aria-expanded="false"
          role="button">
